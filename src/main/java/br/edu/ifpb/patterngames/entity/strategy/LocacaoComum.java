 ...
 * @author Natarajan
 */
public class LocacaoComum implements LocacaoStrategy{

    final static BigDecimal PRECO = new BigDecimal(3);
    final static Integer DURACAO = 1;
    
    private final static BigDecimal MULTA_BASE = new BigDecimal(1);
